...
export const translations = {
  ja: {
    ...
    customPromptsDesc:
      "右クリックメニューと回答後のボタンに表示されます。名前と内容を自由に設定できます。",
    customPromptName: "名前",
    customPromptBody: "プロンプト内容",
    customPromptNamePlaceholder: "例: 深掘り",
    customPromptBodyPlaceholder: "このプロンプトで送る指示を入力",
    attachFiles: "添付",
  ...
  en: {
    ...
    customPromptsDesc:
      "Shown in the right-click menu and as buttons after a reply. Set the name and content freely.",
